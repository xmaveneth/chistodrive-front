...
export default function TimeRangePicker({
    ...
    return (
        <div className={cn('mb-3 bg-input-bg', className)}>
            <div className="text-white w-full text-sm md:text-base md:py-3 md:px-6 input-field py-2 px-4 rounded-full flex items-center justify-between shadow-sm gap-2 divide-x-1 divide-text-muted/50">
