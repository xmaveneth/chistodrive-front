...
export function AccountAcrhived({ entry, onClick }: AccountAcrhivedProps) {
    ...
    return (
        ...
        >
            ...
            <button onClick={() => setShowPopup(true)} className="z-10 relative cursor-pointer flex items-start gap-1 flex-wrap text-xs sm:text-sm hover:text-white/70 text-text-muted md:justify-end pr-5">
                Оставить отзыв
