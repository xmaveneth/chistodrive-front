...
export function AdminCarwashCard({ carwash }: AdminCarwashCardProps) {
    return (
        <button className="w-full px-3 py-3 pl-6 bg-input-bg rounded-2xl break-word text-left cursor-pointer transition-colors duration-200 ease-in hover:bg-zinc-700/60">
